  ...
  return (
    <AboutSection id="about" offset={offset}>
      ...
      <Content offset={offset}>
        <Description>
          I'm a passionate self taught web designer with a keen eye for detail and a love for creating beautiful, 
          functional websites. With expertise in modern web technologies and design principles, 
          I will bring your ideas to life through clean code and intuitive user experiences.
        </Description>
        <Description>
        ...
        <Description>
          This website is my portfolio, therefore it is always under construction.
        </Description>
        <Skills>
